...
exports.getAnamnese = async (req, res) => {
    try {
        ...
        const anamnese = await Anamnese.findOne({ userId });
...
exports.updateAnamnese = async (req, res) => {
    try {
        ...
        let anamnese = await Anamnese.findOne({ userId });
        ...
        if (anamnese) {
            ...
            if (injuries) anamnese.injuries = Array.isArray(injuries) ? injuries : [];
            if (surgeries) anamnese.surgeries = surgeries;
            if (medications) anamnese.medications = Array.isArray(medications) ? medications : [];
            ...
            if (goals) anamnese.goals = goals;
            if (preferredExercises) anamnese.preferredExercises = preferredExercises;
            if (avoidedExercises) anamnese.avoidedExercises = avoidedExercises;
            ...
            if (dietaryRestrictions) anamnese.dietaryRestrictions = dietaryRestrictions;
